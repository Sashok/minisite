 ...
 <? include("blocks/header.php");?>
  <tr class="body">
    <td valign="top">
		...
		if (isset($id))
		{
		$result = mysql_query("DELETE FROM new WHERE id='$id'");
		
		if ($result == 'true') 
		{echo "<p>$Lang[Your_news_are_successfully_remote]</p>";} 
		else 
		{echo "<p>$Lang[Your_news_are_not_remote]</p>";}
		}
		else
		{
		echo "<p>$Lang[You_started_this_file]</p>";
		} 
		?>
